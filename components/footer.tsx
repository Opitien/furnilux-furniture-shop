    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold mb-4">Furnilux</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/shop?category=Sofas" className="text-gray-300 hover:text-white">
                  Sofas
                </Link>
              </li>
              <li>
                <Link href="/shop?category=Dining" className="text-gray-300 hover:text-white">
                  Dining
                </Link>
              </li>
              <li>
                <Link href="/shop?category=Bedroom" className="text-gray-300 hover:text-white">
                  Bedroom
                </Link>
              </li>
              <li>
                <Link href="/shop?category=Office" className="text-gray-300 hover:text-white">
                  Office
                </Link>
              </li>
            </ul>
